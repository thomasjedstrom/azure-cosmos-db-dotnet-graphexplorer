...
1. Update the App.config with your Cosmos credentials and specs.  If this project was cloned from the Azure Quickstart blade in the portal, this step should have already been done for you)
...
3. Run the application (F5).  (This will populate your Cosmos DB graph with the test data)
